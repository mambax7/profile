...
function xoops_module_update_profile(XoopsModule $module, $oldversion = null)
{
    ...
    if ($oldversion < 100) {
        ...
        while ($myrow = $GLOBALS['xoopsDB']->fetchArray($result)) {
            ...
            $groups_visible = $gpermHandler->getGroupIds('profile_visible', $myrow['fieldid'], $module->getVar('mid'));
            $groups_show    = $gpermHandler->getGroupIds('profile_show', $myrow['fieldid'], $module->getVar('mid'));
