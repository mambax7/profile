...
$adminObject->addItemButton(_ADD . ' ' . _PROFILE_AM_STEP, 'step.php?op=new', 'add', '');
    ...
    case 'delete':
        ...
        if (isset($_REQUEST['ok']) && $_REQUEST['ok'] == 1) {
            ...
            xoops_confirm(array(
                              'ok' => 1,
                              'id' => $_REQUEST['id'],
                              'op' => 'delete'), Request::getString('REQUEST_URI', '', 'SERVER'), sprintf(_PROFILE_AM_RUSUREDEL, $obj->getVar('step_name')));
        }
        break;
